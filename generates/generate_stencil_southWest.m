...
syms T_etaE T_etae real 
syms T_Nepsilon T_epsilon real
...
% Build hole stecil acounting for quadratic lambda like in Helmholtz 
  ...
  DDT =( C_etae^2*dy_e_ne*dTdx_etae - C_etae^2*dx_e_ne*dTdy_etae ...
       + C_nepsilon^2*dy_ne_n*dTdx_nepsilon  - C_nepsilon^2*dx_ne_n*dTdy_nepsilon)/S_etaepsilon;
