...
syms C_sigmae C_sigma C_sigmaw real
...
% Build hole stecil acounting for quadratic lambda like in Helmholtz 
  ...
  DDT =( C_s^2*dy_sw_se*dTdx_s     - C_s^2*dx_sw_se*dTdy_s ...
       + C_sigmae^2*dy_se_e*dTdx_sigmae - C_sigmae^2*dx_se_e*dTdy_sigmae ...
       + C_sigmaw^2*dy_w_sw*dTdx_sigmaw - C_sigmaw^2*dx_w_sw*dTdy_sigmaw)/S_sigma;
