...
syms T_omega T_Somega T_sigma T_sigmaW real
...
% Build hole stecil acounting for quadratic lambda like in Helmholtz 
  ...
  DDT =(  C_somega^2*dy_sw_s*dTdx_somega -  C_somega^2*dx_sw_s*dTdy_somega ...
       +  C_sigmaw^2*dy_w_sw*dTdx_sigmaw -  C_sigmaw^2*dx_w_sw*dTdy_sigmaw)/S_sigmaomega;
