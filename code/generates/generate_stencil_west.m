...
syms C_nepsilon C_sepsilon C_epsilon real
...
C_nepsilon=(C_ne+C_n)/2;
C_sepsilon= (C_se+C_s)/2;
...
% Build hole stecil acounting for quadratic lambda like in Helmholtz 
  ...
  DDT =( C_sepsilon^2*dy_s_se*dTdx_sepsilon - C_sepsilon^2*dx_s_se*dTdy_sepsilon ...
       + C_e^2*dy_se_ne*dTdx_e - C_e^2*dx_se_ne*dTdy_e ...
       + C_nepsilon^2*dy_ne_n*dTdx_nepsilon - C_nepsilon^2*dx_ne_n*dTdy_nepsilon)/S_epsilon;
